...
class PwmGeneration
{
   public:
      ...
      static void SetControllerGains(s32fp dkp, s32fp dki, s32fp qkp, s32fp qki);
   private:
      ...
      static int32_t PiController(s32fp refVal, s32fp curVal, s32fp& sum, s32fp kp, s32fp ki);
};
